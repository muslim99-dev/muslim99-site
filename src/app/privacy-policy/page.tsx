  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-[1200px] px-5 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-foreground mb-6 text-3xl font-bold">1. Information we collect:</h2>
          ...
          <div className="mb-8">
            ...
            <p className="text-foreground mb-3 text-lg font-medium">They are:</p>

            <ul className="mb-6 list-disc space-y-3 pl-5">
              <li className="text-foreground marker:text-foreground text-lg leading-relaxed marker:text-[14px]">
          ...
          <div>
            <h3 className="text-foreground mb-4 text-2xl font-bold">1.2 App analytics:</h3>
            <p className="text-foreground text-lg leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-foreground mb-6 text-3xl font-bold">3. Who gets your information:</h2>
          <p className="text-foreground text-lg leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-foreground mb-6 text-3xl font-bold">5. Privacy policy changes:</h2>
          <p className="text-foreground text-lg leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-foreground mb-6 text-3xl font-bold">6. Deleting your data:</h2>
          <p className="text-foreground mb-4 text-lg leading-relaxed">
        ...
        {/* 7. Disclaimers */}
        <section className="mb-12">
          <h2 className="text-foreground mb-6 text-3xl font-bold">7. Disclaimers:</h2>
