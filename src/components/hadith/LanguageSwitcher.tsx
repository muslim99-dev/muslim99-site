...
export default function LanguageSwitcher({ availableLanguages }: { availableLanguages: HadithLanguage[] }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        <Languages size={15} />
        <span className="max-w-[7rem] truncate">{current?.nativeName ?? "Language"}</span>
      </button>
          ...
          >
            {availableLanguages.map((lang) => {
              ...
              return (
                ...
                >
                  <span dir={lang.direction} className={lang.direction === "rtl" ? "font-arabic" : ""}>
                    {lang.nativeName}
                  </span>
